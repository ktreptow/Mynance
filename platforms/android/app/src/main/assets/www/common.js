...
/***/ "./src/app/konto/konto.module.ts":
/*!***************************************!*\
  !*** ./src/app/konto/konto.module.ts ***!
  \***************************************/
/*! exports provided: KontoPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KontoPageModule", function() { return KontoPageModule; });
...
/* harmony import */ var _konto_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./konto.page */ "./src/app/konto/konto.page.ts");
...
var routes = [
    {
        path: '',
        component: _konto_page__WEBPACK_IMPORTED_MODULE_5__["KontoPage"]
    }
];
var KontoPageModule = /** @class */ (function () {
    function KontoPageModule() {
    }
    KontoPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_konto_page__WEBPACK_IMPORTED_MODULE_5__["KontoPage"]]
        })
    ], KontoPageModule);
    return KontoPageModule;
}());
...
/***/ "./src/app/konto/konto.page.ts":
/*!*************************************!*\
  !*** ./src/app/konto/konto.page.ts ***!
  \*************************************/
/*! exports provided: KontoPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KontoPage", function() { return KontoPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var KontoPage = /** @class */ (function () {
    function KontoPage() {
    }
    KontoPage.prototype.ngOnInit = function () {
    };
    KontoPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-konto',
            template: __webpack_require__(/*! ./konto.page.html */ "./src/app/konto/konto.page.html"),
            styles: [__webpack_require__(/*! ./konto.page.scss */ "./src/app/konto/konto.page.scss")],
        }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _plans_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./plans.page */ "./src/app/plans/plans.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _plans_page__WEBPACK_IMPORTED_MODULE_5__["PlansPage"]
    }
];
var PlansPageModule = /** @class */ (function () {
    ...
    PlansPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_plans_page__WEBPACK_IMPORTED_MODULE_5__["PlansPage"]]
        })
    ], PlansPageModule);
...
var PlansPage = /** @class */ (function () {
    ...
    PlansPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-plans',
            template: __webpack_require__(/*! ./plans.page.html */ "./src/app/plans/plans.page.html"),
            styles: [__webpack_require__(/*! ./plans.page.scss */ "./src/app/plans/plans.page.scss")],
        }),
        __metadata("design:paramtypes", [])
    ], PlansPage);
    return PlansPage;
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/dist/index.js");
/* harmony import */ var _transactions_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./transactions.page */ "./src/app/transactions/transactions.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _transactions_page__WEBPACK_IMPORTED_MODULE_5__["TransactionsPage"]
    }
];
var TransactionsPageModule = /** @class */ (function () {
    ...
    TransactionsPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_transactions_page__WEBPACK_IMPORTED_MODULE_5__["TransactionsPage"]]
        })
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Transaktionen</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\nTransaktionsseite\n</ion-content>\n"
